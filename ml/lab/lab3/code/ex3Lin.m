% Exercise 3 -- Linear Regression with regularization
clear all; close all; %clc

% Load data from a two-column ascii file

clear all; close all; clc
x = load('ex3Linx.dat'); y = load('ex3Liny.dat');
...
% The regularization parameter (Try different lambda's)
lambda = 0;
...
plot(x_vals, features*theta, '--', 'LineWidth', 3, 'color', 'blue')
